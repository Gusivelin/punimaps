'use client'
import { FaVials, FaLaptopCode } from 'react-icons/fa'
import { MdEngineering } from 'react-icons/md'

export default function LaboratoriosPage() {
  const laboratorios = [
    { nombre: 'Laboratorio de Química', icono: <FaVials size={40} /> },
    { nombre: 'Laboratorio de Computación', icono: <FaLaptopCode size={40} /> },
    { nombre: 'Laboratorio de Soldadura', icono: <MdEngineering size={40} /> }
  ]
  ...
  return (
    <section style={{
      ...
      <h1 style={{ fontSize: '2.5rem', marginBottom: '2rem', color: '#fff' }}>Laboratorios</h1>
      <div style={{
        display: 'flex',
        gap: '1rem',
        flexWrap: 'wrap',
